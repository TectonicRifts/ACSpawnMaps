...
def convert_spawn_map(file_folder, file_name):
												...
												if k6 == 'origin':
													for k7, v7 in v6.items():
														if k7 == 'x':
															...
															origin_z = v7
													my_origin_list.append(str(origin_x) + ', ' + str(origin_y) + ', ' + str(origin_z))
													...
													for k7, v7 in v6.items():
														if k7 == 'w':
															...
															angles_z = v7
													my_angles_list.append(str(angles_w) + ', ' + str(angles_x) + ', ' + str(angles_y) + ', ' + str(angles_z))
	...
	with open(output_file, 'w') as file_object:
		...
		file_object.write("DELETE FROM `landblock_instance` WHERE `landblock` = 0x" + str(landblock_4).upper() + ";\n\n")
		
		for i, j, k, l, m, n in zip(my_wcid_list, my_cell_list, my_origin_list, my_angles_list, my_desc_list, my_id_list):
			...
			file_object.write("INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)\n")
			file_object.write('VALUES (' + guid + ', ' + str(i) + ', ' + str(j) + ', ' + str(k) + ', ' + str(l) + ', ' + is_link_child + ", '" + today + " 00:00:00');\n")
		...
		for o, p, q in zip(targets, sources, link_descriptions):
			...
			if start_line:
				file_object.write("INSERT INTO `landblock_instance_link` (`parent_GUID`, `child_GUID`, `last_Modified`)\n")
