													...
													if k6 == 'origin':
														for k7, v7 in v6.items():
															if k7 == 'x':
																...
																origin_z = v7
														self.origin_list.append(str(origin_x) + ', ' + str(origin_y) + ', ' + str(origin_z))
														...
														for k7, v7 in v6.items():
															if k7 == 'w':
																...
																angles_z = v7
														self.angles_list.append(str(angles_w) + ', ' + str(angles_x) + ', ' + str(angles_y) + ', ' + str(angles_z))
														
											elif k5 =='objcell_id':
												cell = v5		
												self.cell_list.append(cell)
		
		for i, j, k, l, m, n in zip(my_id_list, my_wcid_list, my_desc_list, self.origin_list, self.angles_list, self.cell_list):
