...
class LandblockEntry():
	...
	def get_json_entry(self):
		...
		entry = '{"id": ' + str(self.guid) + ', "wcid": ' + str(self.wcid) + ', "desc": "' + self.desc + '", ' + '"pos": { "frame": { "origin": { "x": ' + str(self.ox) + ', "y": ' + str(self.oy) + ', "z": ' + str(self.oz) + '}, ' + '"angles": { ' + '"w": ' + str(self.aw) + ', "x": ' + str(self.ax) + ', "y": ' + str(self.ay) + ', "z": ' + str(self.az) + '}}, ' + '"objcell_id": ' + str(self.cell)  + ' }}'
		return entry
...
class GeneratorLink():
	...
	def get_json_entry(self):
		...
		entry = '{"_linkinfo": "' + self.desc + '", "source": ' + str(self.child) + ', "target": ' + str(self.parent) + ' }'
		return entry
